...
read -p "Digite o subdomínio (ex: velocidade.seudominio.com.br): " dominio
...
openSSL.server.certificateFile = /etc/letsencrypt/live/$dominio/fullchain.pem
openSSL.server.privateKeyFile = /etc/letsencrypt/live/$dominio/privkey.pem
EOF
